    ...
    public class MainActivity : AppCompatActivity, IOnSuccessListener, IOnFailureListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DefaultSignIn)
                .RequestIdToken("658677552199-575mfhqm7l8usasof9mpoqinmg954vd9.apps.googleusercontent.com")
                .RequestEmail()
                .Build();
        ...
        private FirebaseAuth GetFirebaseAuth()
        {
            ...
            if (app == null)
            {
                var options = new FirebaseOptions.Builder()
                    .SetProjectId("androidfirebaseauth-47ed0")
                    .SetApplicationId("androidfirebaseauth-47ed0")
                    .SetApiKey("AIzaSyCqBZ6AcuGc1J4ha1IikYT6LtCf1yj_DnI")
                    .SetDatabaseUrl("androidfirebaseauth-47ed0.firebaseio.com")
                    .SetStorageBucket("androidfirebaseauth-47ed0.appspot.com")
                    .Build();
